...
public class TrafficAnimation extends JPanel {
	...
	public void paintComponent(Graphics canvas) 
	{
		...
		canvas.drawArc(x +squareSide/2,y+squareSide ,squareSide/3 , squareSide/3, x2, 60);
		canvas.drawArc(x +squareSide/2,y+squareSide ,squareSide/3 , squareSide/3, x2+120, 60);
		canvas.drawArc(x+squareSide/2,y+squareSide ,squareSide/3 , squareSide/3, x2+240, 60);
		
		
		canvas.drawArc(x2,y ,squareSide/3 , squareSide/3, x, 60);
		canvas.drawArc(x2,y ,squareSide/3 , squareSide/3, x+120, 60);
		canvas.drawArc(x2,y ,squareSide/3 , squareSide/3, x+240, 60);
		
		canvas.drawArc(x2+squareSide/2,y ,squareSide/3 , squareSide/3, x, 60);
		canvas.drawArc(x2+squareSide/2,y ,squareSide/3 , squareSide/3, x+120, 60);
		canvas.drawArc(x2+squareSide/2,y ,squareSide/3 , squareSide/3, x+240, 60);
