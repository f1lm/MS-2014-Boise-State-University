...
public class ScalablePie extends JPanel
{

	/* This is the method responsible for drawing everything you
	 * see in the GUI panel.
	 * 
	 * (non-Javadoc)
	...
	////////////////////////////////////////
	//DO NOT MODIFY main() or ScalablePie()
	////////////////////////////////////////
	
	/**
	 * Starting point for ScalablePie application.
	 * @param args unused
	 */
	public static void main (String[] args)
	{
		JFrame frame = new JFrame ("ScalablePie");
		frame.setDefaultCloseOperation (JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().add(new ScalablePie());
		frame.pack();
