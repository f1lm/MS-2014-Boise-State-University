...
public class DoAddressBuffer extends DataObject {
  ...
  public static final AbstractAttribute[] attributes = {
    ...
    new VarcharAttribute("Adreﬂzusatz 1", "ADRZS1", 40),
    new VarcharAttribute("Adreﬂzusatz 2.", "ADRZS2", 40),
    ...
    new VarcharAttribute("Straﬂe", "STRASS", 60),
  ...
  public String[] getAdresslines() {
    ...
    if (isPostbox || this.getText("PLZ").trim().equals("")) { // letzteres = "Groﬂkunden"
