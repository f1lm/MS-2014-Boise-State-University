	...
	function chalhun() {
		...
		require(['jquery183'], function () {
			LinksAlphaSocialIconJS = new function() {
				var BASE_URL = '//www.linksalpha.com';
				var randomnumber = Math.floor(Math.random()*100000000001)
				var LA_SELECTED_ELEM_ID = 'linksalpha_tag_'+randomnumber;
				var LA_SELECTED_ELEM_DATA_URL;
				function linksalpha_load() {
		        	linksalpha_load_css();
		        	$('a.linksalpha_button:not(a[id^=linksalpha_tag_]):first').attr('id', LA_SELECTED_ELEM_ID);
		        	$(document.body).append(linksalpha_html(LA_SELECTED_ELEM_ID));
		        ...
		        function linksalpha_load_css() {
					if (typeof window.LinksAlphaSocialIconJS=="undefined") {
						$( document.createElement('link') ).attr({
			                href: BASE_URL + '/stylesheets/social_iconbox.css',
			                type: 'text/css',
			                rel: 'stylesheet'
			            }).appendTo('head');
		        ...
		        function linksalpha_content() {
		        	...
		        	LA_SELECTED_ELEM_DATA_URL = LA_SELECTED_ELEM.attr('data-url');
		        	...
		        	$("#"+DIALOG_ELEMENT_BASE+"_"+LA_SELECTED_ELEM_ID).find("div.linksalpha_button_icon_box").each(function(){
		        		...
		        		icon_link_href = icon_link_href+"&url="+encodeURIComponent(LA_SELECTED_ELEM_DATA_URL);
		        		if(icon_link.hasClass('linksalpha_button_url_title')) {
        					...
        					if(LA_SELECTED_ELEM_DATA_DESC) {
	        					icon_link_href = icon_link_href+"&body="+encodeURIComponent(LA_SELECTED_ELEM_DATA_DESC+"... "+LA_SELECTED_ELEM_DATA_URL);
	        				} else {
	        					icon_link_href = icon_link_href+"&body="+encodeURIComponent(LA_SELECTED_ELEM_DATA_URL);
	        				}
					...
					LA_SELECTED_ELEM.attr('href', share_href);
		        }
		        function linksalpha_info(){
		        	if($("#linksalpha_info_loader").length==0) {
		        		var social_query = [];
		        		social_query.push(encodeURIComponent('link') + "=" + encodeURIComponent(LA_SELECTED_ELEM_DATA_URL));
			        	...
			        	var this_url = BASE_URL+'/social/info_3?v=2&'+social_query;
				...
				function linksalpha_dialog_events() {
		        	if(!SmartPhone.isAny()) {
				    	...
				    	var LA_SELECTED_ELEM = $("#"+LA_SELECTED_ELEM_ID);
			        	LA_SELECTED_ELEM.hover(function(){
			        		linksalpha_dialog_events_hc(this_elem);
			        	});
				    	LA_SELECTED_ELEM.click(function() {
				    		linksalpha_dialog_events_hc(this_elem);
				    		return false;
				    	});
			        }
			    ...
			    function linksalpha_dialog_events_hc(this_elem){
	            	...
	            	setTimeout(function() {
	            		var LA_SELECTED_ELEM = $("#"+LA_SELECTED_ELEM_ID);
	            		if (!this_elem.is(":hover") && !LA_SELECTED_ELEM.is(":hover")) {
