...
var applicationUrl = "http://mobile.geek.com/";

var rootUrl = "www.geek.com";
...
if (window.location.href.indexOf(window.location.protocol + "//" + rootUrl) !== 0) { return; }
...
// Platform enables
var redirectPlatforms = {"smartphone":true,"tablet":false};
...
window.Pressly.Detect = (function() {
  ...
  function detect (callback) {
    callback = callback || function (label) { console.log(label); };
    ...
    requestAnimationFrame(function(){
      ...
      requestAnimationFrame(function () {
        ...
        area = Math.min(after.innerWidth  * after.innerHeight,
                        after.outerWidth  * after.outerHeight,
                        after.screenWidth * after.screenHeight);
...
Pressly.redirect = function(platform) {
  ...
  if (forceRedirect || (redirectPlatforms[platform] && Pressly.Device.supportsMinimumRequirements())) {
    ...
    var path = window.location.href.replace(/\?.+$/, "").split(rootUrl)[1];
