...
var sitecodePrefixCHE='che:';var sitecodeSAccountCHED='chroneduglobaldev';var sitecodeSAccountCHEP='chroneduglobal,chroneduprodv2';var sitecodePrefixCOP='cop:';var sitecodeSAccountCOPD='chroneduglobaldev';var sitecodeSAccountCOPP='chroneduphilprodv2';if(!Z||!s_account)
...
function sc_jobapply_click(){var s=s_gi(s_account);s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='events,eVar41,eVar20,prop20';s.linkTrackEvents=s.events='event26';s.tl(true,'o',Z+'job apply click');s.linkTrackVars=s.linkTrackEvents=''}
...
s.trackExternalLinks=s.usePlugins=false;s.linkTrackVars='eVar72,eVar57,eVar41,events';s.linkTrackEvents=s.events='event'+e;s.eVar72='+2';s.eVar57=service;s.tl(true,'o',Z+a+'-share:st');s.linkTrackVars=s.linkTrackEvents=''}
