...
var MondayColor = "red"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "rgb(158, 202, 67);"; //Background color of Saturday.
...
var HoverColor = "rgb(158, 202, 67)"; //color when mouse move over.
...
{ //Generate table cell with value
	...
	if (PValue !== "")
	{
		if (PClickable === false) {
		    ...
		    { PCellStr = "<td id='c" + PValue + "' class='calTD' style='text-align:center;cursor:pointer;width:100px;background-color:"+pColor+"' onmousedown='selectDate(this," + PValue + ");'>" + PValue + "</td>"; }
		    else { PCellStr = "<td class='calTD' style='text-align:center;cursor:pointer;width:100px;background-color:" + pColor + "' onmouseover='changeBorder(this, 0);' onmouseout=\"changeBorder(this, 1, '" + pColor + "');\" onClick=\"javascript:callback('" + Cal.Ctrl + "','" + Cal.FormatDate(PValue) + "');\">" + PValue + "</td>"; }
		}
		else
		{ PCellStr = "<td style='text-align:center;width:100px;background-color:"+pColor+"' class='calTD'>"+PValue+"</td>"; }
	}
	else
	{ PCellStr = "<td style='text-align:center;width:100px;background-color:"+pColor+"' class='calTD'>&nbsp;</td>"; }
...
function RenderCssCal(bNewCal)
{
	...
	vCalHeader += "<tr><td><p style='font-size: 12px;'><img src='basicRedBox.png' style='width:20px;'>&nbsp; - For WeekDays</p></td></tr>"
	vCalHeader += "<tr><td><p style='font-size: 12px;margin-top: -10px;'><img src='Stage_re_green_box_with_light_275px.jpg' style='width:20px;'>&nbsp; - For WeekEnds</p></td></tr>"
