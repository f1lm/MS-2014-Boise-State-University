...
.content-fragment.captcha-blog-post-comment-form .internal-link.add-reply:hover {background: #442059;}
...
a.sidebar-tile-home {
  background: #68217a url(http://blogs.technet.com/cfs-filesystemfile.ashx/__key/communityserver-blogs-components-weblogfiles/00-00-00-94-25/5417.home.png) 50% 50% no-repeat;
}
...
a.sidebar-tile-contact {
  background: #68217a url(http://blogs.technet.com/cfs-filesystemfile.ashx/__key/communityserver-blogs-components-weblogfiles/00-00-00-94-25/5340.icon_2D00_email_2D00_large.png) 50% 50% no-repeat;
}
...
/* Begin STB header */
	...
	/* Begin global STB header */
		...
		#stb-header a h2 {font: 100 3em/*36px*//1.166/*42px*/ 'Segoe UI Light','Segoe UI','Lucida Grande',Verdana,Arial,Helvetica,sans-serif; margin: 11px 0 20px; color: #68217a; position: relative; top: 3px;}
	...
	/* Begin STB Tier 3 header */
		.stb-nav {background: #68217a;}		
		.stb-nav > li > a.menu-title:hover, .stb-nav .stb-nav-drop, .stb-nav > li > a.menu-title.expanded {background: #442059;}
		.menu-title.expanded {.field_wrapper:after { content: "."; display: block; height: 0; clear: both; visibility: hidden; }}
		.stb-nav-drop > li > a:hover, .stb-nav > li > a.menu-title {background: #68217a;}
		.stb-nav-drop a {border-left: 0 !important;}
		.description-container .description  h2, .content-fragment.with-header .content-fragment-header div, .content-fragment.link-list .content-list-name {color: #68217a;}
    .content-fragment.with-header .content-fragment-header div a {color: #68217a; font-weight: bold;}
...
/* Begin tabs and container for sxp */
	...
	#sxp-tabs {margin: 0 0 30px; width: 718px; background: #68217a; height: 32px; padding: 0 !important; border-bottom: solid 1px #ccc; font-size: 1.167em;}
...
/*Use the following only when a blog description is used under the title*/ *:first-child+html .stb-nav-drop.expanded {top: 159px;}
...
/* Visual Studio ALM specific styles */
#sxp-tabs {
  background: none;
}
#sxp-tabs a {
...
.sxp-feed p.sxp-time-author-comments {
  margin-bottom: 8px;
}