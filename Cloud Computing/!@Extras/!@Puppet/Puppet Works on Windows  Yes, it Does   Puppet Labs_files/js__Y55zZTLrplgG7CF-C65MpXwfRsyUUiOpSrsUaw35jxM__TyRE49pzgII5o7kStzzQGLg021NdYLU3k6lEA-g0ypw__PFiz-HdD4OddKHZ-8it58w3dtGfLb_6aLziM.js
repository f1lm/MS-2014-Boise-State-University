...
(function( $, Drupal ) {
  $(document).ready(function() {
    ...
    /**
     * HANDLE: Handle Modernizr returning all Windows 8 as a touch device.
     * - Since Modernizr treats all Windows 8 instances as though they are touch enabled we must detect for windows 8
     * and make sure the 'no-touch' class is applied in place of the 'touch' class.
     */
