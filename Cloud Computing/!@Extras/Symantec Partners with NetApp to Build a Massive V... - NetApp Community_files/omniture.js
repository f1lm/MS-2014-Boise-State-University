...
Omniture.Listeners = {
    ...
    attachHomePageListeners: function() {
        ...
        $('#main .homeModules .hmodule:first a').mousedown(function() {
            var params = {
                eVar45: 'hp comp left ' + $(this).attr('href'),
                events: 'event7'
            };
            Omniture.Call.customLink({href: '/'}, params);
        });
        $('#main .homeModules div.hmodule:nth-child(2) a').mousedown(function() {
            var params = {
                eVar45: 'hp comp center ' + $(this).attr('href'),
                events: 'event7'
            };
            Omniture.Call.customLink({href: '/'}, params);
        });
        $('#main .homeModules .hmodule:last').mousedown(function() {
            var params = {
                eVar45: 'hp comp right FC Module',
                events: 'event7'
            };
            Omniture.Call.customLink({href: '/'}, params);
        });
