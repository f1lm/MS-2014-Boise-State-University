  ...
  Foundation.libs.section = {
    ...
    toggle_active : function (e, self) {
      var $this = $(this),
          ...
          prev_active_section = parent
            .children(self.settings.active_region_selector).not(region);
      ...
      if (region.hasClass('active')) {
        ...
        if (prev_active_section.length > 0 && !self.is_accordion(parent)) {
          prev_active_section
            .removeClass('active')
            .attr('style', '');
        }
    ...
    resize : function () {
      ...
      sections.each(function() {
        ...
        if (active_section.length > 1 && !self.is_accordion(active_section.parent())) {
          // active_section
          //   .not(':first')
          //   .removeClass('active')
          //   .attr('style', '');
