...
_pa.segments = [{"name":"All visitors","id":1770016,"regex":".*"}];
_pa.conversions = [];
_pa.conversionEvents = [{"name":"careernew","id":"259188"},{"name":"newproplan","id":"287769"}];
_pa.segmentEvents = [{"name":"newproplan","id":2110904}];
_pa.rtbId = '25058';
_pa.siteId = '5399c8ae7416471111000150';
