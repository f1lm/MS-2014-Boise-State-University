...
function s_doPlugins(s) {
	...
	//g to hcode mapping
    if (typeof(s_prop8)   != 'undefined' && !s.prop8)  {s.prop8 = s_prop8;}	
	if (typeof(s_prop9)   != 'undefined' && !s.prop9)  {s.prop9 = s_prop9;}
	if (typeof(s_prop10)  != 'undefined' && !s.prop10) {s.prop10 = s_prop10;}
	if (typeof(s_prop31)  != 'undefined' && !s.prop31) {s.prop31 = s_prop31;}
	if (typeof(s_prop32)  != 'undefined' && !s.prop32) {s.prop32 = s_prop32;}
	if (typeof(s_prop33)  != 'undefined' && !s.prop33) {s.prop33 = s_prop33;}
	if (typeof(s_prop34)  != 'undefined' && !s.prop34) {s.prop34 = s_prop34;}
	if (typeof(s_prop35)  != 'undefined' && !s.prop35) {s.prop35 = s_prop35;}
	if (typeof(s_prop36)  != 'undefined' && !s.prop36) {s.prop36 = s_prop36;}
	if (typeof(s_prop37)  != 'undefined' && !s.prop37) {s.prop37 = s_prop37;}
	if (typeof(s_prop38)  != 'undefined' && !s.prop38) {s.prop38 = s_prop38;}
	if (typeof(s_prop39)  != 'undefined' && !s.prop39) {s.prop39 = s_prop39;}
	if (typeof(results)  != 'undefined' && !s.prop40) {s.prop40 = results[0];}
	...
	s.hier3=set_h3();
	s.prop11=s.prop10 + " | " + s.prop36;
	s.prop12=s.prop9 + " | " + s.prop10;
	
	//CNBC Top story by hour, weekend, and weekday data 
	var partDate=new Date(); 
	var partYear=partDate.getFullYear(); 
	s.prop25=s.getTimeParting('h','-5',partYear); // Set hour 
	s.prop29=s.getTimeParting('d','-5',partYear); // Set day
	s.prop30=s.getTimeParting('w','-5',partYear); // Set Weekend / Weekday
	...
	if (!s_parsedQueryString) {
		...
		s.prop73=s.eVar23=s.getQueryParam("par"); 
		...
		s.prop53=s.eVar53=s.getQueryParam("content");

		s_parsedQueryString = true;
	} else {
		s.eVar20 = '';
		s.eVar24 = '';
		s.eVar23 = '';
	...
	//new repeat plug-in settings
	var _n = 0;
	if(s.c_r('_s_nr')) {
		_n = Number(s.c_r('_s_nr').substring(0, s.c_r('_s_nr').indexOf('-')));
		_n = new Date(_n).getMonth();
	}
		
	var _t = new Date().getMonth();
	if(_n < _t || s.c_r('_s_nr2')) {
		s.prop13 = 'New';
		s.c_w('_s_nr2','New');
	} else {
		s.prop13 = 'Repeat';
	...
	s.eVar1=s.prop13;
	s.prop72 = s.getNewRepeat(90, '_s_nr');	//rolling 90 days
	s.eVar72 = s.prop72;
	
	//User Agent String Tracking
	s.prop44=s.eVar44="D=User-Agent";
	
	//additional eVar tracking
	if (s.prop37!="") s.eVar32=s.prop37; //doc type 
	if (s.prop31!="") s.eVar67=s.prop31; //site section
	if (s.prop32!="") s.eVar68=s.prop32; //site sub section
	if (s.prop33!="") s.eVar69=s.prop33; //site sub sub section
	if (s.prop34!="") s.eVar70=s.prop34; //microsection
	if (s.prop35!="") s.eVar71=s.prop35; //nano section
	if (s.prop45!="") s.eVar45=s.prop45; //Site Version
	if (s.prop46!="") s.eVar46=s.prop46; //Deck Status
}
