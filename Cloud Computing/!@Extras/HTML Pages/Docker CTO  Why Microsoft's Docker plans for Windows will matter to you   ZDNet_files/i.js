...
bouncex.website = {"cae":false,"ei":0,"cookie_name":"bounceClientVisit765","base_host":"bounceexchange.com","vars":{"is_logged_in":{"polling":"none","persist":"no","val":"jQuery('.nav.expandable.siteUtils.loggedIn .menu').text().toLowerCase().indexOf('log out')!=-1","default":"false"},"register_driver_bouncex":{"polling":"none","persist":"no","val":"window.top.location.href.indexOf('omniture[registration_driver]=bouncex') > -1","default":"false"}},"acts":[],"pi":1000,"ct":"bind_to_domain","tcjs":"","cjs":"window.bouncex.log('init');\njQuery(document).ready(function(){\nif(jQuery('.mmode-register form').length>0){\n\t\/*window.bouncex.log('initp');*\/\n\tconsole.log('hay');\n\tjQuery('.mmode-register form').submit(function(){\n\t\tsetTimeout(function(){\n\t\t\tif(jQuery('.modalTitle').is(':visible') && jQuery('.modalTitle').text()==\"Activate Your Account\") {\n\t\t\t\t\/*window.bouncex.log('conv3');*\/\n\t\t\t\twindow.bouncex.report_conversion({email:jQuery('.mmode-register form [name=email]').val(),goal:'regPage'});\n\t\t\t}\n\t\t},2500);\n\t\t\n\t\tif(bouncex.vars.register_driver_bouncex){\n\t\t\t\twindow.bouncex.report_conversion({email:jQuery('.mmode-register form [name=email]').val(),goal:'regPage'});\n\t\t}\n\t\t\n\t})\n}\n\nelse if(jQuery('.registrationForm').length>0){\n\t\/*window.bouncex.log('initf');*\/\n\tjQuery('.registrationForm').submit(function(){\n\t\tsetTimeout(function(){\n\t\t\tif(jQuery('.modalTitle').is(':visible') && jQuery('.modalTitle').text()==\"Activate Your Account\") {\n\t\t\t\t\/*window.bouncex.log('conv4');*\/\n\t\t\t\twindow.bouncex.report_conversion({email:jQuery.trim(jQuery('.modalBody').text().match(\/.+@.+\\..+\/)),goal:'regPopup1'});\n\t\t\t}\n\t\t},2500);\n\t\t\n\t\t\n\t})\n}\n\nelse {\n\t\/*window.bouncex.log('inita1')*\/\n\tjQuery('a[data-member=showRegister]').click(function(){\n\t\t\/*window.bouncex.log('initb');*\/\n\t\tsetTimeout(function(){\n\t\t\t\/*window.bouncex.log('initc');*\/\n\t\t\tif(jQuery('.registrationForm').length>0){\n\t\t\t\t\/*window.bouncex.log('initd');*\/\n\t\t\t\tjQuery('.registrationForm').submit(function(){\n\t\t\t\t\tsetTimeout(function(){\n\t\t\t\t\t\tif(jQuery('.modalTitle').is(':visible') && jQuery('.modalTitle').text()==\"Activate Your Account\") {\n\t\t\t\t\t\t\t\/*window.bouncex.log('conv4');*\/\n\t\t\t\t\t\t\twindow.bouncex.report_conversion({email:jQuery.trim(jQuery('.modalBody').text().match(\/.+@.+\\..+\/)),goal:'regPopup2'});\n\t\t\t\t\t\t}\n\t\t\t\t\t},2500);\n\t\t\t\t})\n\t\t\t}\n\t\t},2000);\n\t});\n}\n});\n\n\n","PMI":500,"PDI":1000,"PMR":30,"force_https":false,"waypoints":false,"gai":"","ots":0,"sd":0,"aco":{"first_party_limit":"3500"},"id":765,"campaign_id":0,"tpc":0,"uwc":1,"domain":"zdnet.com","bau":"http:\/\/bounceexchange.com\/","is_preview":false,"mas":1,"map":1,"burls":[],"ibx":{"cjs":"","miw":"0","mibcx":0,"te":0,"tjs":"","cart_rep":{"get":"","set":""}}};
...
var bcx_init = function(){
	...
	if(bouncex.website.is_preview){
		...
		bouncex.baddjs(window.location.protocol + '//'+bouncex.website.base_host+'/bounce/initp.js?campaign_id='+bouncex.website.campaign_id+'&resolution='+resolution);
		...
		if(areCookiesEnabled()){
			...
			bouncex.make_include_string = function(type){
				...
				var bcx_str = (bouncex.website.force_https?'https:':window.location.protocol) + '//'+bouncex.website.base_host+'/bounce/'+type+'.js?tojQ='+tojQ+'&tzo='+tzo+'&is_preview='+(bouncex.website.is_preview?'true':'false')+'&website_id='+bouncex.website.id+'&resolution='+resolution+'&referrer='+bouncex.referrer+'&calling_url='+bouncex.calling_url+'&visit_cookie='+escape(visit_cookie)+'&cookie='+escape(cookie)+bcx_vars.replace(/\+/g,'%2B')+bcx_persist;
				return bcx_str;
			}
...
if(bouncex.website.ct=='multi_cookie'){
	setBounceCookie = function (){
		...
		bouncex.multicookie.set(c_name,bouncex.stringify(bouncex.cookie));
		jQuery('<img src="'+bouncex.website.bau+'capture/update_cookie?cookie_name='+c_name+'&cookie='+encodeURIComponent(bouncex.stringify(bouncex.cookie))+'" />');
	}
}else{ 
	setBounceCookie = function (){
		var c_name = bouncex.website.cookie_name;
		...
		if(bouncex.website.tpc){
			...
			jQuery('<img src="'+bouncex.website.bau+'capture/update_cookie?cookie_name='+c_name+'&cookie='+escape(bouncex.stringify(bouncex.cookie))+'" />');
		}else{
			var exdate = new Date();
...
(function(){
	...
	function activation_funcs(){var e=[];e["manual"]=function(e,t,n){};e["control"]=function(e,t,n){show_ad("control",n)};e["inter"]=function(e,t,n){if(bouncex.cookie.vpv>=e){show_ad("inter",n)}};e["bounce"]=function(e,t,n){bxBind("html,body","mouseout.bouncex_show_"+n,function(e){process_mouse_out(e,n)});if(bouncex.browser.msie||bouncex.browser.safari&&bouncex.browser.safari<=50){bxBind("html,body","mousemove.bouncex_show_"+n,function(e){process_mouse_move(e,n)})}init_helpers(n)};e["timer"]=function(e,t,n){bouncex_events["timeout_timer"+n]=setTimeout(function(){show_ad("timer",n)},parseInt(t)*1e3)};e["back"]=function(e,t,n){var r=false;if(e=="landing_page"){if(bouncex.state.iol){r=true}}else{r=true}if(r){activate_hash(n)}};e["pers"]=function(e,t,n){var r=false;bouncex.campaigns[n].is_pers=true;if(e=="landing_page"&&bouncex.state.iol){r=true}else if(e!="landing_page"){r=true}if(r){show_ad("pers",n)}};e["worm"]=function(e,t,n){noteCookieAdShown(n,true);teleport("_self",t)};e["inactivity"]=function(e,t,n){bouncex.inactivity_events="mousemove.bouncex keydown.bouncex DOMMouseScroll.bouncex mousewheel.bouncex mousedown.bouncex touchstart.bouncex touchmove.bouncex";bxBind(document.body,bouncex.inactivity_events,function(){clearTimeout(bouncex.inactivity_timeout);bouncex.inactivity_timeout=bouncex_events["inactivity"+n]=setInactivityTimeout(n,t)});bouncex.inactivity_timeout=setInactivityTimeout(n,t)};e["scroll"]=function(e,t,n){bouncex.oldSy=100;bxBind(window,"scroll.bouncex_"+n,function(){var e=jQuery(this);var r=bouncex.wndsize();var i=e.scrollTop();i=i?i:document.body.scrollTop;var s=(i+r.height)/jQuery(document).height()*100;var o=parseInt(s)+parseInt(t);if(o>100&&s>bouncex.oldSy&&!bouncex.campaigns[n].ad_shown){show_ad("scroll",n);if(!can_show_ad(n,true)){jQuery(window).unbind("scroll.bouncex_"+n)}}bouncex.oldSy=s})};e["mclick"]=function(e,t,n){if(e=="left"&&bouncex.campaigns[n].overlay=="teleport"&&bouncex.campaigns[n].overlay_teleport_type!=="_self"){var r=function(){show_ad("mclick",n)};addEvent(window.document,"click",r)}else{var r=function(t){var i=t.keyCode||t.which||t.button;if(t.button&&t.button==2)i=3;if(e=="left"&&i==1||e=="any"){show_ad("mclick",n)}if(e=="right"&&i==3||e=="any"){show_ad("mclick",n)}if(!can_show_ad(n,true)){removeEvent(window.document,"mousedown",r)}};addEvent(window.document,"mousedown",r)}};return e}
        ...
        bouncex.browser.iphone = nav.indexOf('iphone');
