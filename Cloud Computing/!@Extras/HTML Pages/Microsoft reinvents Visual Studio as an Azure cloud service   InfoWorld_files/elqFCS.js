...
if (elqTryI){ document.write('<ifr' + 'ame name="elqFCSFra" style="display: none" src="/elqNow/elqBlank.htm" width=1 height=1 frameborder=0 border=0 NORESIZE SCROLLING="no"><\/ifr' + 'ame>');}
