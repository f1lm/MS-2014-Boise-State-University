...
if(typeof __ntap_dmdbase !== 'undefined') {
    ...
    var __dmdbase_sf = ('watch_list' in db && 's5000-flag' in db.watch_list) ? db.watch_list["s5000-flag"] : 'No Match';
    var __dmdbase_sp = ('watch_list' in db && 's5000-penetration' in db.watch_list) ? db.watch_list["s5000-penetration"] : 'No Match';
    var __dmdbase_cd = ('watch_list' in db && 'cdot' in db.watch_list) ? db.watch_list["cdot"] : 'No Match';

    var __dmdbase_cn = ('company_name' in db) ? db.company_name : 'No Match';
    var __dmdbase_in = ('industry' in db) ? db.industry : 'No Match';
    var __dmdbase_si = ('sub_industry' in db) ? db.sub_industry : 'No Match';
    var __dmdbase_f1000 = ('fortune_1000' in db) ? db.fortune_1000 : 'No Match';
    var __dmdbase_f2000 = ('fortune_2000' in db) ? db.fortune_2000 : 'No Match';
    var __dmdbase_er = ('employee_range' in db) ? db.employee_range : 'No Match';
    var __dmdbase_rr = ('revenue_range' in db) ? db.revenue_range : 'No Match';
    var __dmdbase_isp = ('isp' in db) ? db.isp + '' : 'No Match';
    var __dmdbase_au = ('audience' in db) ? db.audience : 'No Match';
    var __dmdbase_as = ('audience_segment' in db) ? db.audience_segment : 'No Match';
    //var __dmdbase_ao = ('watch_list' in db && 'aoo-classification' in db.watch_list) ? db.watch_list["aoo-classification"] : 'No Match';
    //var __dmdbase_ip = ('ip' in db) ? db.ip : 'No Match';
    //var __dmdbase_rc = ('country_name' in db) ? db.country_name : 'No Match';
    s.eVar17 = __dmdbase_cn;
    s.eVar18 = __dmdbase_in;
    s.eVar19 = __dmdbase_er;
    s.eVar20 = __dmdbase_rr;
    s.eVar21 = __dmdbase_si;
    //s.eVar23 = __dmdbase_isp;
    s.eVar24 = __dmdbase_f1000;
    s.eVar25 = __dmdbase_au;
    s.eVar26 = __dmdbase_as;
    s.eVar64 = __dmdbase_sf;
    s.eVar65 = __dmdbase_f2000;
    s.eVar66 = __dmdbase_sp;
    s.eVar68 = __dmdbase_cd;
    s.prop54 = __dmdbase_cn;
    s.prop55 = __dmdbase_in;
    s.prop56 = __dmdbase_er;
    s.prop57 = __dmdbase_rr;
    s.prop58 = __dmdbase_si;
    s.prop60 = __dmdbase_isp;
    s.prop61 = __dmdbase_f1000;
    s.prop62 = __dmdbase_au;
    s.prop63 = __dmdbase_as;
    s.prop64 = __dmdbase_sf;
    s.prop65 = __dmdbase_f2000;
    s.prop66 = __dmdbase_sp;
    s.prop67 = __dmdbase_cd;
}
...
/* new Adobe Connector related javascript update */
