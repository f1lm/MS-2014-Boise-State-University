              ...
              //tls warning:homegrown not fielded
                ...
                "oneLetterNumberSymbolUpperLower": {
                  "regex": /(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])(?=.*[^a-zA-Z0-9\s])(.{8,40})/,
                    "alertText": "• One uppercase letter, lowercase letter, number, and symbol character is required",
                    "alertText2": "Minimum of 8 to maximum 40 characters"
                },
                "notGartner": {
                ...
                "multiEmailsRule":{
                    ...
                    "alertText": "• Required field, please use <br> a comma or ; for multiple addresses"
                },
                "ajaxClientEmail": {
