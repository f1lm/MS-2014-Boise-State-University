...
/**
 * A simple helper for tracking omniture event
 * ** WARNING - This object needs to persist if we upgrade this file to a new version **
 */
...
/*
 * This object provides meaningful names to the Omniture custom events
 * ** WARNING - This object needs to persist if we upgrade this file to a new version **
 */
...
function addOmnitureEvent(eventName) {
    if (s.events === '') {
        s.events = window.OmnitureEventsMap[eventName];
    } else {
        s.events += ',' + window.OmnitureEventsMap[eventName];
    }
}
