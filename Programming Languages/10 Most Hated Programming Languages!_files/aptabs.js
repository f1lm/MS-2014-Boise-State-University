var apTabs = {
	...
	path: 'images/ap/',	// Path to the images
	...
	defaultHeight:250,	// Default height
	...
	show: function(e, tab) {
		if (typeof(e) == 'string') {
			e = $(e);
			tab = e.down('.tabLabels').childElements()[tab - 1];
		}
		if (e.className != 'apTabs') {
			e = e.up('.apTabs');
			tab = e.down('.tabLabels').childElements()[tab - 1];
		}
		apTabs.hideAll(e);
	...
	scroll: function(e, w) {
		var tabWidth = apTabs.getTabWidth(e);
